 ...
 <body class="bg-blue-500">
  <div class="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden">
   ...
   <div class="p-4">
    ...
    <a href="{{ route('donaturs.showCategory', $category->slug) }}">
     <div class="flex-none w-24 text-center">
      <img alt="{{ $category->name }}" class="w-16 h-16 mx-auto" height="64" src="{{ asset('icons/' . $category->icon) }}" width="64"/>
